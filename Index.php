...
<head>
	...
	<link rel="icon" type="image/png" href="https://i.pinimg.com/736x/53/cc/27/53cc278ecb261fa62497b8a18be6fc96.jpg"> 

	<title>Hacked By PsychoMoonSix</title>

	<meta name="description" content="&#1203;&#824;&#1202;&#824;&#1203; Jakarta blackHat &#1203;&#824;&#1202;&#824;&#1203;"> <link href="https://fonts.googleapis.com/css?family=Merienda&amp;display=swap" rel="stylesheet">
	...
	img[alt*="https://i.ibb.co/P5BrVD4/129784-adapted-1080x2160.jpg "]{display:none}</style> 
	...
	<script language="javascript"> function onKeyDown() { // current pressed key var pressedKey = String.fromCharCode(event.keyCode).toLowerCase(); if (event.ctrlKey && (pressedKey == "c" || pressedKey == "v" || pressedKey == "u")) { // disable key press porcessing event.returnValue = false; } } // onKeyDown </script> </head> <body onload="randombg()" id="random" onkeydown="onKeyDown()"> 
		...
		<p> Hacked By PsychoMoonSix </p><p>Gretz :<br> Jakarta Black Hat </div> <center> </center> <style> body { background: url("https://64.media.tumblr.com/02d1f76324f05100f1b5d7189a384da1/tumblr_ptn4hdw5C01roqdm2_540.gif") no-repeat fixed; background-size: 100% 100%; background-color: black; color: white; } } </style><iframe allow="autoplay" allowfullscreen="0" frameborder="0" height="0" loop='true' src='https://g.top4top.io/m_1738upsbi1.mp3' width='0'></iframe> </body> </html>
